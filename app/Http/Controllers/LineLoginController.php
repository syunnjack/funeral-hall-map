    ...
    public function callback(Request $request)
    {
        ...
        if ($intendedVenueId) {
            ...
            if ($venue) {
                ...
                return redirect()->route('venues.show', $venue)->with('success', '通知登録が完了しました。新しい費用の口コミが投稿されるとLINEでお知らせします。');
            }
        }
        ...
        if ($intendedDocumentVenueId) {
            ...
            if ($venue) {
                ...
                return redirect()->route('venues.show', $venue)->with('success', '「' . $venue->name . '」への事前相談・資料請求を受け付けました。LINEで受付完了のお知らせをお送りします。');
            }
        }
